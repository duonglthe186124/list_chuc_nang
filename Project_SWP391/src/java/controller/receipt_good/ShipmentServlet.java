...
import service.ManageShipmentService;

public class ShipmentServlet extends HttpServlet {

    private static final ManageShipmentService service = new ManageShipmentService();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Response_ShipmentDTO> shipment_list = new ArrayList();
        ...
        try {
            shipment_list = service.get_shipment_list(search, status, page_size, page_no);
        } catch (IllegalArgumentException e) {
        ...
        request.setAttribute("shipment_list", shipment_list);
        request.setAttribute("search", search);
        request.setAttribute("status", status);
        request.setAttribute("pageInput", page_no);
        request.setAttribute("totalItems", total_items);
        request.getRequestDispatcher("/WEB-INF/view/shipments.jsp").forward(request, response);
    }
