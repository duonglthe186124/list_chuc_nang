...
public class OrderList {
    private int orderNumber, orderQuantity, shipMentId, shippedQuantity;
    ...
    public OrderList(int orderNumber, int orderQuantity, int shipMentId, int shippedQuantity, String productName, String cusName, String cusEmail, String cusPhone, String cusAddress, String orderStatus, String shipmentStatus, String shipmentNote, String shipperName, String shipperEmail, String shipperPhone, BigDecimal productUnitPrice, BigDecimal orderAmount, Timestamp orderDate, Timestamp shipmentDate) {
