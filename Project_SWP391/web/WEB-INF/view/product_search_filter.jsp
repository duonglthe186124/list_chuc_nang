    ...
    <body>
        ...
        <div class="layout">
            ...
            <main class="main">
                ...
                <a href="${pageContext.request.contextPath}/home"><button type="button">Home</button></a><a href="${pageContext.request.contextPath}/order/list"><button type="button">View Order List</button></a>
