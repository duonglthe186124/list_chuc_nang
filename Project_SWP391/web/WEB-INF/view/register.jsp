...
<body>
    <div class="register-container">
        ...
        <form id="registerForm" action="RegisterStaff" method="post">
            ...
            <p class="login-link">
                You have an account? <a href="${pageContext.request.contextPath}/loginStaff">Login</a>
            </p>
        </form>
    </div>

    <script src="${pageContext.request.contextPath}/resources/js/validation_register.js"></script>
</body>
</html>