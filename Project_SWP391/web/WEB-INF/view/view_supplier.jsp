            ...
            <main
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-3xl font-bold text-gray-800">Chi Tiết Nhà Cung Cấp</h1>
                        <div class="flex space-x-3">
                            <a href="${pageContext.request.contextPath}/inbound/suppliers" 
                               class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-300 transition duration-150 flex items-center space-x-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                                <span>Quay lại</span>
                            </a>
                            <a href="${pageContext.request.contextPath}/inbound/suppliers/update?id=${supplier.supplier_id}" 
                               class="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition duration-150 flex items-center space-x-1">
                    ...
                    <c:if test="${not empty supplier}">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-1">
                                ...
                                <p class="text-base text-gray-800 font-semibold border-b border-gray-100 pb-2">${supplier.supplier_name}</p>
                            </div>

                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-500">Tên Hiển Thị</label>
                                <p class="text-base text-gray-800 border-b border-gray-100 pb-2">${supplier.display_name}</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-500">Người Đại Diện</label>
                                <p class="text-base text-gray-800 border-b border-gray-100 pb-2">${supplier.representative}</p>
                            </div>

                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-500">Phương Thức Thanh Toán</label>
                                <p class="text-base text-gray-800 border-b border-gray-100 pb-2">${supplier.payment_method}</p>
                            </div>
                        </div>

                        <h3 class="text-xl font-bold text-gray-700 mt-10 mb-4 border-b-2 pb-2 border-indigo-100">Thông Tin Liên Hệ</h3>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-500">Điện Thoại</label>
                                <p class="text-base text-gray-800 font-mono">${supplier.phone}</p>
                            </div>

                            <div class="space-y-1 md:col-span-2">
                                <label class="block text-sm font-medium text-gray-500">Email</label>
                                <p class="text-base text-gray-800 font-mono">${supplier.email}</p>
                            </div>
                        </div>

                        <div class="mt-6 space-y-1">
                            <label class="block text-sm font-medium text-gray-500">Địa Chỉ</label>
                            <p class="text-base text-gray-800 p-3 bg-gray-50 rounded-lg border border-gray-200">${supplier.address}</p>
                        </div>

                        <div class="mt-6 space-y-1">
                            <label class="block text-sm font-medium text-gray-500">Ghi Chú</label>
                            <div class="mt-1 p-4 bg-gray-50 border border-gray-200 rounded-lg h-32 overflow-y-auto">
                                <p class="text-sm text-gray-700 whitespace-pre-wrap">${supplier.note}</p>
                            </div>
                        </div>
                    </div>
                </c:if>
                ...
                <c:if test="${empty supplier}">
                    <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded-lg shadow-lg">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-red-800">Không tìm thấy nhà cung cấp</h3>
                                <p class="mt-2 text-sm text-red-700">
                                    Nhà cung cấp có ID được yêu cầu không tồn tại hoặc đã bị xóa.
                                </p>
                            </div>
                        </div>
                    </div>
