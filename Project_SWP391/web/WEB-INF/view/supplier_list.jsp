...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Hover effects */
            .action-view:hover { background-color: #bfdbfe; }
            .action-update:hover { background-color: #a7f3d0; }
            .action-delete:hover { background-color: #fecaca; }
                    ...
                    <div class="w-full p-0 sm:p-0">
                        <header
                            ...
                            <button
                                ...
                                <span>Tạo thông tin nhà cung cấp mới</span>
                            </button>
                        </header>
                ...
                if (currentData.length === 0) {
                    ...
                    currentData.forEach((tx, index) => {
                        ...
                        rowsHtml += '\n<tr>\n' +
                                ...
                                '<td class="action-cell"><a href="${pageContext.request.contextPath}/inbound/transactions/view?id=' + tx.id + '" class="action-view mr-3">View</a>\n' +
                                '<a href="${pageContext.request.contextPath}/' + tx.id + '" class="action-update mr-3">Update</a>\n' +
                                '<a href="${pageContext.request.contextPath}/' + tx.id + '" class="action-delete mr-3">Delete</a></td>\n' +
                                '</tr>';
                    });
                }
