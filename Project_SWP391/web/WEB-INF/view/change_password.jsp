    ...
    <body class="bg-white text-gray-800">
        ...
        <main class="pt-24 pb-16">
            <div class="max-w-md mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg">
                <h2 class="text-3xl font-bold text-center mb-8 text-gray-900">Change password</h2>
                <form action="${pageContext.request.contextPath}/change-password" method="post" class="space-y-6">
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <button type="submit" 
                                class="flex-1 py-3 px-4 bg-gray-400 text-gray-900 font-medium rounded-lg transition duration-200 hover:bg-gray-500">
                            Change
                        </button>
                    </div>
                </form>
