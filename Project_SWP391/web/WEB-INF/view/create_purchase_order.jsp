        ...
        <div class="layout">
            <aside class="sidebar" aria-label="Sidebaar">
                ...
                <div class="sidebar-menu">
                    <button class="menu-item">Overview</button>
                    <a class="menu-item" href="transaction_history.html">Transaction history</a>
                    <button class="menu-item">Purchase Order History</button>
                    <button class="menu-item active">Create purchase order</button>
