    ...
    <body>
        ...
        <div class="social-login">
            <button type="button" class="social-btn google-btn">
                <img src="${pageContext.request.contextPath}/resources/images/google.webp" alt="Google Icon">
                Continue with Google
            </button>
            <button type="button" class="social-btn phone-btn">
                 <img src="${pageContext.request.contextPath}/resources/images/phone.jpg" alt="Phone Icon">
